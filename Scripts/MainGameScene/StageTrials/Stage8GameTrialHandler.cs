...
public class Stage8GameTrialHandler : MonoBehaviour
{
    public AudioManager audioManager;
    public Animator clockAnimator;
    public GameObject MainStage8TrialPanel,SettingPanel;
    ...
    public void OpenStage8Trial()
    {
        StartCoroutine(OpenStage8TrialPanel());
        DisableDigitButtons();
    }
    private IEnumerator OpenStage8TrialPanel()
    {
        MainStage8TrialPanel.SetActive(true);
    ...
    private void GenerateQuestion()
    {
        ...
        if (questionText != null)
        {
            ...
            for (int i = 1; i < numOperands; i++)
            {
                questionText.text += " x " + operands[i].ToString();
            }
            questionText.text += " =";
        }
    ...
    private void EndGame(bool isVictory)
    {
        ...
        if (isVictory)
        {
            ...
            firebaseManager.UpdateStage8Task(true);
        }
        else
        {
    ...
    public void CloseMainStage8GameTrialPanel()
    {
        MainStage8TrialPanel.SetActive(false);
        DefeatPanel.SetActive(false);
        VictoryPanel.SetActive(false);
