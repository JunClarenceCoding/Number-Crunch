...
public class Stage17BattleHandler : MonoBehaviour
{
   ...
   void Start()
    ...
    private void FetchMathSettings()
    {
        ...
        FirebaseDatabase.DefaultInstance.GetReference("MathSettings/Stage 17").GetValueAsync().ContinueWith(task =>
        {
    ...
    {
        int currentStage = 17; // Set this to your actual current stage
    ...
    private IEnumerator HandleVictorySequence(bool isStageCleared)
    {
        ...
        int xpReward = isStageCleared ? 120 : 680; 
    ...
    public void RecordTotalAttempt()
    {
        ...
        // Directly specify the stage key ("stage17")
