...
using System;
public class Stage18BattleHandler : MonoBehaviour
{
   ...
   void Start()
    ...
    private void FetchMathSettings()
    {
        ...
        FirebaseDatabase.DefaultInstance.GetReference("MathSettings/Stage 18").GetValueAsync().ContinueWith(task =>
        {
    ...
    {
        int currentStage = 18; // Set this to your actual current stage
    ...
    private IEnumerator HandleVictorySequence(bool isStageCleared)
    {
        ...
        int xpReward = isStageCleared ? 150 : 720;
        int coinReward = isStageCleared ? 50 : 350; 
    ...
    public void RecordTotalAttempt()
    {
        ...
        // Directly specify the stage key ("stage18")
