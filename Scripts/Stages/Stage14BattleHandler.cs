...
using System;
public class Stage14BattleHandler : MonoBehaviour
{
   ...
   void Start()
    ...
    private void FetchMathSettings()
    {
        ...
        FirebaseDatabase.DefaultInstance.GetReference("MathSettings/Stage 14").GetValueAsync().ContinueWith(task =>
        {
    ...
    {
        int currentStage = 14; // Set this to your actual current stage
    ...
    private IEnumerator HandleVictorySequence(bool isStageCleared)
    {
        ...
        int xpReward = isStageCleared ? 90 : 600; 
        int coinReward = isStageCleared ? 40 : 320; 
    ...
    public void RecordTotalAttempt()
    {
        ...
        // Directly specify the stage key ("stage14")
