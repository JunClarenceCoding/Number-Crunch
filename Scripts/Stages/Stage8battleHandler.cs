...
public class Stage8BattleHandler : MonoBehaviour
{
    public Boss8Dialogue boss8Dialogue;
    ...
    private void FetchMathSettings()
    {
        ...
        FirebaseDatabase.DefaultInstance.GetReference("MathSettings/Stage 8").GetValueAsync().ContinueWith(task =>
        {
   ...
   private void SetDigitButtonsInteractable(bool state)
    ...
    {
        int currentStage = 8; // Set this to your actual current stage
    ...
    private IEnumerator HandleVictorySequence(bool isStageCleared)
    {
        ...
        int xpReward = isStageCleared ? 90 : 900; 
        int coinReward = isStageCleared ? 40 : 600; 
    ...
    public void HandleStageBasedVictoryCheck()
    {
        StartCoroutine(CheckStageCleared((isStageCleared) =>
        {
            ...
            {
                boss8Dialogue.StartVictoryDialogue();
            }
        }));
    }
    ...
    public void RecordTotalAttempt()
    {
        ...
        // Directly specify the stage key ("stage08")
