...
public class Stage11BattleHandler : MonoBehaviour
{
    ...
    private void FetchMathSettings()
    {
        ...
        FirebaseDatabase.DefaultInstance.GetReference("MathSettings/Stage 11").GetValueAsync().ContinueWith(task =>
        {
    ...
    {
        int currentStage = 11; // Set this to your actual current stage
    ...
    private IEnumerator HandleVictorySequence(bool isStageCleared)
    {
        ...
        int xpReward = isStageCleared ? 75 : 500; 
        int coinReward = isStageCleared ? 40 : 280; 
    ...
    public void RecordTotalAttempt()
    {
        ...
        // Directly specify the stage key ("stage11")
